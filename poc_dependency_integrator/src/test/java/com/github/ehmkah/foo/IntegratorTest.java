...
public class IntegratorTest {
    ...
    public void testExampl1() throws IOException {
        // GIVEN
        final File inputFile = new File("src/test/resources/example1/build.gradle");
        final File expectedFile = new File("src/test/resources/example1/expected.example1.gradle");
